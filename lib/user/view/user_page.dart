  ...
  Widget build(BuildContext context) => SliverAppBar(
    ...
    bottom: PreferredSize(
      ...
      child: UserTile(
        ...
        onTap: (context, user) => scrollController.animateTo(
          0,
...
class _UserSearchAnchorState() extends State<_UserSearchAnchor> {
  ...
  void initState() {
    ...
    _searchController = SearchController()
      ...
      ..addListener(
        () => widget._userItemSearchBloc.add(
...
class const _SliverUserBody(
  ...
  final AuthCubit _authCubit,
  final SettingsCubit _settingsCubit, {
  final bool isLoggedInUser = false,
}) extends StatelessWidget {
  @override
  Widget build(BuildContext context) => BlocBuilder<UserCubit, UserState>(
    bloc: _userCubit,
        ...
        slivers: [
          ...
          if (state.data?.submittedIds case final submittedIds?)
            SuperSliverListExtension.builder(
              ...
              itemBuilder: (context, index) {
                final int id = submittedIds[index];
