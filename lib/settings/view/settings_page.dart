...
class const SettingsPage(final SettingsCubit _settingsCubit, {super.key})
...
class const _SliverSettingsAppBar() extends StatelessWidget {
  ...
  Widget build(BuildContext context) =>
      SliverAppBar.medium(title: Text(context.l10n.settings));
}

class const _SettingsBody(final SettingsCubit _settingsCubit)
    extends StatelessWidget {
  ...
  ) => BlocPresentationListener<SettingsCubit, SettingsPresentationEvent>(
    bloc: _settingsCubit,
      ...
      builder: (context, state) => Column(
        ...
        children: [
          ...
          ListTile(
            ...
            onTap: () => context.push<void>(AppRoute.filtersDialog.location()),
          ),
          const Divider(),
          Padding(
            padding: AppSpacing.defaultTilePadding,
